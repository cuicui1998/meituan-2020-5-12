    ...
    <div class="footer-list">
      ...
      <div class="footer-column">
        <dl>
          ...
          <dd>
            <a href="https://xue.meituan.com/?from=mtpc" target="_blank">外卖配送加盟申请</a>
          </dd>
          <dd>
            <a
              rel="nofollow"
          ...
          <dd>
            <a rel="nofollow" href="https://phoenix.meituan.com/about/" target="_blank">综合商家入驻</a>
          </dd>
          <dd>
            <a href="http://pc.meituan.com/?activity_code=mtpcdb" target="_blank">美团民宿房东商家入驻</a>
          </dd>
          <dd>
            <a
              rel="nofollow"
          ...
          <dd>
            <a rel="nofollow" href="http://developer.meituan.com/" target="_blank">美图点评餐饮开放平台</a>
          </dd>
          <dd>
            <a rel="nofollow" href="http://smartpay.meituan.com/" target="_blank">美团点评收单</a>
          </dd>
          <dd>
            <a
              rel="nofollow"
    ...
    <div class="footer-copyright">
      <div class="left">
        <p>
          ...
          <a href="#" class="zheng">京ICP证070791号</a>
